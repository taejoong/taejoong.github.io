...
\begin{tabular}{rl} {\bf Location} & Online Class (Zoom link is avialable on Canvas) \\
    {\bf Time} & Mondays and Wednesdays 05:30\textsc{pm}--06:45\textsc{pm}\\
    {\bf Forum} & https://canvas.vt.edu/courses/115628 \\ 
    {\bf Instructor} & Prof.\ Taejoong (Tijay) Chung\\
    {\bf Contact} & {\tt tijay@vt.edu} (put ``[\course]'' in the subject line)\\ 
    {\bf Office hours} & Wednesdays at 3pm -- 4:30pm (Virtual, the link is available on Canvas)
\\ \\ \end{tabular}
...
CS4254: Computer Network Architecture and Programming {\em or} an equivalent course in computer networks at the senior or graduate level.
